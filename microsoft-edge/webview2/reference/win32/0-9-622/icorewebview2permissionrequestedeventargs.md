...
> общедоступные значения HRESULT [get_PermissionKind](#get_permissionkind)(COREWEBVIEW2_PERMISSION_KIND * PermissionKind)

#### get_State 

Состояние запроса разрешения (например,

> общедоступное значение HRESULT [get_State](#get_state)(COREWEBVIEW2_PERMISSION_STATE * State)
...
> общедоступное значение HRESULT [put_State](#put_state)(состояние COREWEBVIEW2_PERMISSION_STATE)

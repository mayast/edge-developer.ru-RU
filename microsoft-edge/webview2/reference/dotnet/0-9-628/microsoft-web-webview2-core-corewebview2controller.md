...
[ZoomFactorChanged](#zoomfactorchanged) | ZoomFactorChanged активируется, когда изменяется свойство ZoomFactor объекта WebView.
...
> [границы](#bounds) общедоступного прямоугольника
...
В случае, если возникает событие MoveFocusRequested, фокус по-прежнему находится в WebView при срабатывании события MoveFocusRequested. LostFocus срабатывает только в том случае, если код приложения или действие по умолчанию, заданное MoveFocusRequested события, задали фокус от WebView.
...
ZoomFactorChanged активируется, когда изменяется свойство ZoomFactor объекта WebView.
...
> Public void [SetBoundsAndZoomFactor](#setboundsandzoomfactor)(прямоугольные границы, Double ZoomFactor)

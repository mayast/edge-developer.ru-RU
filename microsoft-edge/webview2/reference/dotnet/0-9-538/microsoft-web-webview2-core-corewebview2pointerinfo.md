...
---
# класс 0.9.579-Microsoft. Web. WebView2. Core. CoreWebView2PointerInfo 
...
> общедоступный Rect [DisplayRect](#displayrect)
...
> общедоступный Rect [PointerDeviceRect](#pointerdevicerect)
...
> общедоступный Rect [TouchContact](#touchcontact)
...
> общедоступный Rect [TouchContactRaw](#touchcontactraw)

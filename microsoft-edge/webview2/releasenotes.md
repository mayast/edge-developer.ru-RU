...
Заметки о выпуске [WEBVIEW2 SDK][WebView2NuGetGallery].  
...
* **Объявление:** В дальнейшем мы выпустим два пакета: пакет предварительной версии с экспериментальными API (для пробного использования) и стабильный пакет выпусков с стабильными API (вы можете зависеть от него). Извлеките [Microsoft Edge WEBVIEW2 SDK](./index.md#microsoft-edge-webview2-sdk) , чтобы узнать о различиях.

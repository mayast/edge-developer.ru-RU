...
Встроенные скрипты можно разрешить, указав хэш-код в исходном коде в политике в формате Base64.  Этот хэш-код должен быть префиксом используемого хэш-алгоритма \ (SHA256, SHA384 или SHA512 \).  Пример: [использование хэша для элементов <Script \ >][W3CContentSecurityPolicyLevel2ScriptSrcHashUsage] .  
